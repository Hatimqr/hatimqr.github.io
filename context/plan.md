# Website Content: Hatim Rehmanjee

**Voice:** Sarcastic, dry, competent. Someone who is obsessively good at their job but refuses to take themselves too seriously.
...
**What to emphasize:**
- The "problems that hurt" framing throughout
- Self-awareness ("overkill? absolutely")
- Competence shown through specifics (PCA, K-Means, ILP solvers)
- Dry humor that doesn't undercut the technical work
- The pattern: finds problem → can't stop thinking about it → builds solution

**What to avoid:**
- Corporate buzzwords
- False humility
- Over-explanation
- Apologizing for being good at things
- Treating this like a resume (it's a story)

**The arc:**
1. Open with pain/difficulty as hook
2. Show origin story (dad's spreadsheet = why I do this)
3. Demonstrate pattern (keeps finding/solving problems)
4. Show range (corporate tour across industries)
5. Prove obsessiveness (personal projects)
...
- Professional but definitely not corporate